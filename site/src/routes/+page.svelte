...
<div class="showcase-page">
 <section class="intro wrap">
  ...
  <div class="intro-actions"><a class="button" href={`${base}/download/`}>Get Torbie <span aria-hidden="true"><Icon name="external"/></span></a><button class="quiet-action" onclick={()=>preview.openFullScreen()}><span class="action-label">Try it here</span><span aria-hidden="true"><Icon name="external"/></span></button></div>
 ...
 <section class="small-discoveries wrap" aria-labelledby="discover-title">
  <div class="section-heading"><span class="eyebrow">It’s the little things</span><h2 id="discover-title">Feels familiar.<br />Thinks a little further.</h2><a href={`${base}/features/`}>Explore every feature <Icon name="external"/></a></div>
  <div class="discovery-grid">
   <details class="discovery" data-guide-title="Keep your setup" data-guide="Keep the plugins you already use. Open this card to see compatibility details."><summary><div class="plugin-visual" aria-hidden="true"><span>ssh</span><span class="plugin-center">T</span><span>git</span><span>sftp</span><span>⌘</span></div><div class="discovery-label"><h3>Your plugins.<br />Still at home.</h3><span><Icon name="plus"/></span></div></summary><p>The Tabby plugin API stays in place. Bring the tools that already fit you.</p><a href={`${base}/features/torbie/`}>Compatibility evidence <Icon name="external"/></a></details>
   <details class="discovery" data-guide-title="Understand a stall" data-guide="See what slowed a session down, then open the feature for the recorded breakdown."><summary><div class="diagnostic-visual" aria-hidden="true"><div class="viz-label">One stall, explained <span>71.3s</span></div><div class="timeline"><span></span><span></span><span></span></div><div class="viz-legend"><span>read · 41.0s</span><span>unlink · 28.2s</span></div><div class="viz-footer">98% synchronous I/O <span><Icon name="external"/></span></div></div><div class="discovery-label"><h3>Even the pauses<br />have a story.</h3><span><Icon name="plus"/></span></div></summary><p>A real recorded stall, broken down by the work that blocked it.</p><a href={`${base}/features/diagnostics-log/`}>Inspect the recorded evidence <Icon name="external"/></a></details>
